...
\vspace{0.5cm}
\noindent\textbf{Acknowledgments.} Thanks to roldess22 for substantive critiques during a multi-day exchange of comments on a four-part TikTok exposition of an earlier version of the LARP model. The two-regime cost structure (Section 2), the observation-noise treatment of convergence (Section 3), the endogenous-regime extension (Section 4), and the cognitive-hierarchy framework (Section 5) were each developed in response.
